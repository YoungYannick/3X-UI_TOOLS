...
这是一个 Tampermonkey 脚本，用于增强 3X-UI 面板的功能，提供一键生成节点、关闭订阅访问、添加出站规则以及配置路由规则等便捷操作。

## 描述

该脚本为 3X-UI 面板添加了一个浮动按钮，点击后弹出界面，支持多种协议节点的快速创建（如 VLESS 和 VMESS），并提供其他实用工具。脚本通过 API 与面板交互，实现自动化配置。

## 功能

- **一键生成节点**：支持以下协议的节点创建（VLESS/VMESS）：
